...
const VoiceSelection = ({ onVoiceSelect, selectedVoice, onBack, onNext, userInput }) => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
      ...
      >
        <div className="relative bg-gray-900/60 backdrop-blur-2xl rounded-xl p-3 border border-white/10 shadow-2xl">
          <motion.div 
          ...
          <div className="relative z-10">
            <h2 className="text-lg font-bold mb-3 text-center flex items-center justify-center">
              <motion.div
                animate={{
                  scale: [1, 1.1, 1],
                }}
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-6 pr-2 py-1 bg-gray-800/50 border border-white/10 rounded-lg text-xs text-white placeholder-gray-400 focus:outline-none focus:border-purple-500/50"
                  />
                </div>
                ...
                {activeProvider === 'openai' && (
                  <motion.button
                    ...
                    className="px-2 py-1 bg-blue-500/20 border border-blue-500/30 rounded-lg text-xs text-blue-400 font-medium hover:bg-blue-500/30 transition-all flex items-center"
                  >
