...
function App() {
  const [stage, setStage] = useState(0) // 0: Input, 1: Script Review, 2: Voice, 3: Video
  ...
  const stages = ['Script Creation', 'Script Review', 'Voice Selection', 'Video Assembly']
